...
Stay updated through GetSporty App. Participate in the tournaments of your favourite sports in your area or anywhere in India Stay updated through GetSporty App. Participate in the events or browse for sports trials of your favourite sports in your area or anywhere in India Find a sports job, find sports quota jobs and apply for sports jobs through your GetSporty App Find a sports coach for individual training or participate in a joint practice sessions">
    ...
    <!-- title bar icon-->
    <link rel="icon" type="image/png" href="../resources/assets/img/GS Icon1.png">
    <!-- Font Awesome -->
    ...
    <link href="../resources/assets/css/compiled.min.css" rel="stylesheet">
...
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-N3SWFF5"
...
<div class="se-pre-con">
    ...
    <img class="load" src="gif/loader2.gif" style="    position: fixed;
    ...
    width: 80px;">
		...
		<ul class="nav navbar-nav navmob" >
                ...
                <li class="nav-item">
                    ...
                    <a id="link-2" class="nav-link" href="#about">App Features</a>

                </li>

                <li class="nav-item">

                    <a id="link-3" class="nav-link" href="#news" >Latest Resources</a>

                </li>

                <li class="nav-item">

                    <a id="link-4" class="nav-link" href="#app">Get App</a>

                </li>  

                <li class="nav-item">

                    <a id="link-6" class="nav-link" href="#team">Team</a>

                </li> 

                <li class="nav-item">

                    <a id="link-5" class="nav-link" href="#support">Support</a>
...
<div class="navbar-header trigger">
                ...
                <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1">
                    ...
                    <img src="../resources/assets/img/trigger.png" />
            ...
            <ul class="navbar-nav mr-auto">
                ...
                <li class="">
                       ...
                       <a class="nav-link navbar-brand" href="#bdy">
                            ...
                            <div class="hj-logo"><img src="../resources/assets/img/logo.png"></div>
            ...
            <li   class="nav-item">
                     ...
                     <a href="#" class="nav-link" style="  border-radius: 50%;

      background-color: transparent;padding: 7px 13px;margin-right: 17px;border:1px solid white;" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="fa fa-user" style="    font-size: 24px;" aria-hidden="true"></i></a>

                         

                          <ul class="dropdown-menu" style="left: -222%;width: 227px;margin-top: 18%;

                              padding: 14px;    background-color: rgba(3, 169, 244,0.5);" aria-labelledby="dropdownMenuButton">

                          

                            <li><h2 style="font-size: 20px;  color:#ffffff;  padding-bottom: 16px; padding-left: 9px;">Welcome, User</h2></li>

                            <li class="fl">

                            <a class="dropdown-item" style="font-size: 16px;  color:#ffffff;     border: 1px solid #ffffff;      padding: 5px 13px;" href="#">Profile</a></li>

                            <li class="fr"><a class="dropdown-item" style="    border: 1px solid #ffffff;font-size: 16px;   color:#ffffff;    padding: 5px 13px;" href="#">Sign Out</a></li>
...
<div class="banner"> <div class="container-fluid" id="know_about"> <div class="container"> <div class="row"> <div class="col-sm-6"> <div class="banner-img-wrap animated fadeInLeft" style="padding-top: 100px;text-align: center;padding-bottom: 20px;"> <img src="../resources/assets/img/freezeimage1.png" class="img-responsive wd250 " /> </div> </div> <div class="col-sm-6"> <div class="head1 animated fadeInRight"> Indian first Mobile App <br>for  Aspiring Sports Professionals <br><br> <div class="linkto"> <a href="#about">LEARN MORE</a> <span> <a href="https://play.google.com/store/apps/details?id=getsportylite.darkhoprsesport.com.getsportylite&hl=en">GET APP</a> </span> </div> </div> </div> </div> </div> </div> </div> <!--know about us--> <section class="know_about"  id="about" > <div class="container-fluid" id="know_about" > <div class="container"> <div class="row"> <div class="col-sm-12 spaceAll"> <div class="title" >App Features</div> <div class="sub-heading">Learn more about this feature packed App</div> </div> <div class="col-sm-12 scrollpoint sp-effect1 active animated fadeInLeft" style="margin-bottom: 70px; margin-top: 30px;"> <div class="row"> <div class="col-sm-12 col5 center"> <div class="rel"> <a  class="clk" href="#"> <img class="wd35" src="../resources/assets/img/siteicons/Events.png" /> </a> </div> <div class="media-body"> <h3 class="media-heading">Events</h3> </div> <div class="detail img-1"> We bring you the latest updates on all the big sports events to your GetSporty App. Be it an upcoming sports trial or just a weekend sporting event, get all the information on your phone </div> <div class="mr25"></div> </div> <div class="col-sm-12 col5 center"> <div class="rel"> <a  class="clk" href="#"> <img class="wd35" style="width:60px;" src="../resources/assets/img/siteicons/Tournaments.png" /> </a> </div> <div class="media-body"> <h3 class="media-heading">Tournaments</h3> </div> <div class="detail img-1"> Never miss an opportunity to impress and be never short on practice. Get all the updates on the latest and the upcoming sports tournaments in the area near you </div> <div class="mr25"></div> </div> <div class="col-sm-12 col5 center"> <div class=" rel"> <a id="img-5" class="clk" href="#"> <img class="wd35" src="../resources/assets/img/siteicons/performance.png" /> </a> </div> <div class="media-body"> <h3 class="media-heading">Assessment</h3> </div> <div class="detail img-5">Get your daily performance assessed by professionals or be the master of your own training sessions </div> <div class="mr25"></div> </div> <div class="col-sm-12 col5 center"> <div class="rel"> <a class="clk" href="#"> <img class="wd35" src="../resources/assets/img/siteicons/Jobs.png" /> </a> </div> <div class="media-body"> <h3 class="media-heading">Job Listing</h3> </div> <div class="detail img-3">Find your dream sports job. Browse through all the latest sports jobs in the Goverment or private sector through our specially devoted &quot;Sports Job Portal&quot; </div> <div class="mr25"></div> </div> <div class=" col-sm-12 col5 center"> <div class="rel"> <a  class="clk" href="#"> <img class="wd35" src="../resources/assets/img/siteicons/Log.png" /> </a> </div> <div class="media-body"> <h3 class="media-heading">Resources</h3> </div> <div class="detail img-4">Not an everyday content but a fearsome approach to take on the state of Indian sports and a complete guide to reveal the path for sports enthusiasts to reach the pinnacle of their sport </div> <div class="mr25"></div> </div> </div> </div> <br><br> <div class="col-sm-12 scrollpoint sp-effect2 active animated fadeInRight"> <div class="row"> <div class="col-sm-12 col5 center"> <div class=" rel"> <a id="img-5" class="clk" href="#"> <img class="wd35" style="    margin-bottom: 4.5%;" src="../resources/assets/img/siteicons/Coach.png" /> </a> </div> <div class="media-body"> <h3 class="media-heading">Coach</h3> </div> <div class="detail img-5">Want to become a professional player? For the best result, contact the best coach and train harder and smarter </div> <div class="mr25"></div> </div> <div class="col-sm-12 col5 center"> <div class="rel"> <a id="img-6" class="clk" href="#" onclick="return false;" > <img class="wd35" src="../resources/assets/img/siteicons/Trainer.png" /> </a> </div> <div class="media-body"> <h3 class="media-heading">Training Log</h3> </div> <div class="detail img-6">Track your workouts, save your history and manage your performance with this dedicated training log </div> <div class="mr25"></div> </div> <div class="col-sm-12 col5 center"> <div class=" rel"> <a id="img-7" class="clk" href="#"> <img class="wd35" style="width:33px;" src="../resources/assets/img/siteicons/medal.png" /> </a> </div> <div class="media-body"> <h3 class="media-heading">Post Results</h3> </div> <div class="detail img-7">Give yourself remarks and compare your last day&#39;s performance with your recent results </div> <div class="mr25"></div> </div> <div class="col-sm-12 col5 center"> <div class="rel"> <a id="img-8" class="clk" href="#"> <img class="wd35" src="../resources/assets/img/siteicons/Connect.png" /> </a> </div> <div class="media-body"> <h3 class="media-heading">Connect</h3> </div> <div class="detail img-8">Contact the best professionals, trainers or the coaches to help you refine your skills and be the player that you have always dreamt about </div> <div class="mr25"></div> </div> <div class="col-sm-12 col5 center"> <div class="rel"> <a id="img-9" class="clk" href="#"> <img class="wd35" src="../resources/assets/img/siteicons/Parent.png" /> </a> </div> <div class="media-body"> <h3 class="media-heading">Parent</h3> </div> <div class="detail img-9">Book an upcoming event or tournament or just hire a personal trainer or coach for your child. Keep a tab on your ward&#39;s performance through this unique feature </div> <div class="mr25"></div> </div> </div> </div> </div> </div> </div> </section> <!--/.know about us--> <section class="latest_new" id="news" style="background-color: rgba(9, 40, 213, 0.04);"> <div class="container-fluid"> <div class="container"> <div class="col-sm-12 spaceAll"> <div class="title">Latest Resources</div> <div class="sub-heading">See what’s included in the App </div> </div> <!-- Nav tabs --> <div class="row"> <div class="col-md-12"> <!-- Tab panels --> <div class="tab-content vertical"> <!--Panel 1--> <div class="tab-pane fade in show active" id="panel21" role="tabpanel"> <div id="multi-item-example" class="carousel slide carousel-multi-item" data-ride="carousel"> <!--Controls --> <div class="controls-top"> <a style="position:inherit;" class="btn-floating btn-small" href="#multi-item-example" data-slide="prev"><i class="fa fa-chevron-left"></i></a> <a style="position:inherit;" class="btn-floating btn-small" href="#multi-item-example" data-slide="next"><i class="fa fa-chevron-right"></i></a> </div> <div id="img1" style="top: 0px; background-color: transparent; width: 100%; height: 300px; opacity: 0.7;"> <div  class="loader1"> </div> </div> <!--Slides--> 
    <div class="carousel-inner" role="listbox" id="id1"> <!--/.Second slide--> <!--/.Slides--> </div> </div> </div> </section>

                    <!--        Job Information  -->

<section class="latest_new" id="news" style="background-color:rgb(222, 240, 249);"> <div class="container-fluid"> <div class="container"> <div class="col-sm-12 spaceAll"> <div class="title">Latest Job</div> <div class="sub-heading">See what’s included in the App </div> </div> <!-- Nav tabs --> <div class="row"> <div class="col-md-12"> <!-- Tab panels --> <div class="tab-content vertical"> <!--Panel 1--> <div class="tab-pane fade in show active" id="panel21" role="tabpanel"> <div id="multi-item-exampl2" class="carousel slide carousel-multi-item" data-ride="carousel"> <!--Controls --> <div class="controls-top"> <a style="position:inherit;" class="btn-floating btn-small" href="#multi-item-exampl2" data-slide="prev"><i class="fa fa-chevron-left"></i></a> <a style="position:inherit;" class="btn-floating btn-small" href="#multi-item-exampl2" data-slide="next"><i class="fa fa-chevron-right"></i></a> </div>  <!--Slides--> 
    <div class="carousel-inner" role="listbox" id="id3"> <!--/.Second slide--> <!--/.Slides--> </div> </div> </div> </section>

        <!--        Latest Event & Tournament    -->

   <section class="latest_new" id="news"> <div class="container-fluid"> <div class="container"> <div class="col-sm-12 spaceAll"> <div class="title">Latest Event & Tournament</div> <div class="sub-heading">See what’s included in the App </div> </div>  <div class="row"> <div class="col-md-12"> <div class="tab-content vertical">  <div class="tab-pane fade in show active" id="panel21" role="tabpanel"> <div id="multi-item-exampl" class="carousel slide carousel-multi-item" data-ride="carousel">   <div class="controls-top"> <a style="position:inherit;" class="btn-floating btn-small" href="#multi-item-exampl" data-slide="prev"><i class="fa fa-chevron-left"></i></a> <a style="position:inherit;" class="btn-floating btn-small" href="#multi-item-exampl" data-slide="next"><i class="fa fa-chevron-right"></i>
   </a> </div> 
...
<img style="max-width:120%" src="../resources/assets/img/freezeimage2.png" />
...
<div class="foot-logo"><img src="../resources/assets/img/logo.png"></div>
...
<script type="text/javascript" src="../resources/assets/js/data.js"></script>  
