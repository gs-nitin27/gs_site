	...
	include 'config.php';
	 ...
	 // $tableName = "gs_resources";
	  ...
	  // mysql_set_charset("UTF8");
	   ...
	   $query = mysql_query("SELECT id,title,summary,image,token,url FROM `gs_resources` WHERE `status`= 1 ORDER BY `date_created` DESC" ); 
                ...
                <div class="container">
                    ...
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand custom-logo" href="index.php">
                            <img src="assets/img/freeze/logo11.png" alt="" class="logo">
                        </a>
                    </div>
                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        <ul class="nav navbar-nav navbar-right">
                          ...
                          <!--  <li><a href="#reviews">reviews</a>
							...
							<li><a href="http://portal.getsporty.in/">Login</a>
                            </li>
							<li><a href="http://staging.getsporty.in/index.php/forms/new_registration/">Partner With US!</a>
                            </li>
                        </ul>
                    </div>
                    <!-- /.navbar-collapse -->
                ...
                <ul>
                    ...
                    <li data-transition="fade" data-slotamount="7" data-masterspeed="1500" >
                        ...
                        <div class="tp-caption lfl fadeout hidden-xs"
                            ...
                            <img class="bg-image" src="assets/img/freeze/Slides/hand-freeze.png" alt="">
                        </div>
            ...
            <div class="container" id="latestnews">
                ...
                <div class="slider filtering scrollpoint sp-effect5" >
				 ...
				 <?php
				   ...
				   <div id="corner2">
				   <div id="corner" >		  
				   <div><img src="http://portal.getsporty.in/uploads/resources/<?php echo $test[$i][3]; ?>" alt=""  style=" width:200px ;height:115px;" ></div>
